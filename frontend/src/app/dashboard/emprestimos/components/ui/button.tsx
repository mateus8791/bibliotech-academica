// Arquivo: frontend/src/components/ui/button.tsx (VERSÃO COM FUNÇÃO EMBUTIDA)
...
// --- INÍCIO DA CORREÇÃO ---
// Em vez de importar, definimos a função 'cn' diretamente aqui para contornar o erro.
