// Arquivo: frontend/src/app/dashboard/livros/editar/[id]/EditBookForm.tsx
'use client';
...
export default function EditBookForm({ initialBookData, autores, categorias }: EditBookFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => router.push('/dashboard/livros'), 2000); 
    } catch (error: any) {
    ...
    <div className="bg-white p-8 rounded-xl shadow-lg max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end space-x-4 pt-4">
            <button type="button" onClick={() => router.push('/dashboard/livros')} className="px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300">Cancelar</button>
